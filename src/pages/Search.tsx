...
export default function Search() {
  ...
  // Sync state if URL changes (e.g. searching from the header)
  useEffect(() => {
    setQuery(qParam);
  }, [qParam]);
      ...
      {query.trim() === '' ? (
        ...
        <div className="space-y-6">
          <div className="border-b border-gray-50 pb-4 mb-6 flex justify-between items-baseline">
            ...
            <button onClick={() => handleInputChange('')} className="font-sans text-xs text-blue-600 hover:underline">Clear Search</button>
          </div>
